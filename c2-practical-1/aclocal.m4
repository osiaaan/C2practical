...
dnl -*- autoconf -*-
# Macros needed to find C2-practical and dependent libraries.  They are called by
# the macros in ${top_src_dir}/dependencies.m4, which is generated by
# "dunecontrol autogen"

# Additional checks needed to build C2-practical
# This macro should be invoked by every module which depends on C2-practical, as
# well as by C2-practical itself
AC_DEFUN([C2_PRACTICAL_CHECKS])

# Additional checks needed to find C2-practical
# This macro should be invoked by every module which depends on C2-practical, but
# not by C2-practical itself
AC_DEFUN([C2_PRACTICAL_CHECK_MODULE],
[
  DUNE_CHECK_MODULES([C2-practical],[C2_practical/C2_practical.hh])
])
